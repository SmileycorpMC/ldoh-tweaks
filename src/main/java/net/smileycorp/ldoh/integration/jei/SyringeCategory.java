...
public class SyringeCategory implements IRecipeCategory<Wrapper> {
	...
	public SyringeCategory(IGuiHelper guiHelper) {
		this.background = guiHelper.createDrawable(TEXTURE, 0, 0, 128, 96);
	...
	public static class Wrapper implements IRecipeWrapper {
		...
		public void getIngredients(IIngredients ingredients) {
			ingredients.setInput(ItemStack.class, new ItemStack(ModContent.SYRINGE, 1, 0));
			ingredients.setOutput(ItemStack.class, new ItemStack(ModContent.SYRINGE, 1, 1));
		}
