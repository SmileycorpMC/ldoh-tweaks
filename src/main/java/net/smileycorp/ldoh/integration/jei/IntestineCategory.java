...
import net.smileycorp.ldoh.integration.jei.IntestineCategory.Wrapper;
...
public class IntestineCategory implements IRecipeCategory<Wrapper> {
	...
	public static final ResourceLocation TEXTURE = ModDefinitions.getResource("textures/gui/jei/intestines.png");
	...
	public String getTitle() {
		return I18n.translateToLocal("jei.category.hundreddayz.Intestines").trim();
	}
