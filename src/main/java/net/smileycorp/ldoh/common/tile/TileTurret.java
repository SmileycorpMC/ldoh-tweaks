...
public class TileTurret extends TileEntity {
	...
	public void spawnEntity(EntityPlayer owner, EnumFacing facing, NBTTagCompound nbt) {
		...
		Vec3d pos = new Vec3d(this.pos.getX() + 0.5, this.pos.getY() + 0.5, this.pos.getZ() + 0.5).addVector(vec.getX(), vec.getY(), vec.getZ());
	...
	public void readFromNBT(NBTTagCompound nbt) {
		if (nbt.hasKey("entity") &! world.isRemote) entity = (EntityTurret) world.getEntityByID(nbt.getInteger("entity"));
