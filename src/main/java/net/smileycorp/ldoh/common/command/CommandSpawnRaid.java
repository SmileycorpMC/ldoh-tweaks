...
public class CommandSpawnRaid extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        try {
            ...
            if (type == null || type == RaidType.NONE)
                throw new CommandException("commands." + ModDefinitions.MODID + ".SpawnRaid.invalidValue", new Object[]{new TextComponentTranslation(args[0])});
            ...
            server.addScheduledTask(() -> {
                ...
                if (player.hasCapability(LDOHCapabilities.MINI_RAID, null))
                    player.getCapability(LDOHCapabilities.MINI_RAID, null).spawnRaid(player, type, level);
            });
