...
public class ItemHelmet extends ItemArmor {
	...
	public ItemHelmet(String name, int durability, int protection, float toughness) {
		super(EnumHelper.addArmorMaterial(name, null, durability, new int[]{0, 0, 0, protection}, 0, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, toughness), 0, EntityEquipmentSlot.HEAD);
